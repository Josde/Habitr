...
class _EditRoutineScreenState extends State<EditRoutineScreen> {
  ...
  void initState() {
    ...
    if (widget.routine != null) {
      ...
      title = 'Edit routine';
      if (_currentType == ActivityType.Stopwatch ||
          _currentType == ActivityType.Timer) {
        showLength = true;
      } else {
        showLength = false;
      }
                  ...
                  child: DropdownButtonFormField(
                    ...
                    onChanged: (String? newValue) {
                      setState(() {
                        ...
                        if (chosenDropdownValue == 'Stopwatch' ||
                            chosenDropdownValue == 'Timer') {
                          showLength = true;
                        } else {
                          showLength = false;
                        }
                    ...
                    onSaved: (String? value) {
                      this._currentType = ActivityType
                          .values[this.dropdownValues.indexOf(value!)];
                    },
                  ),
                ),
                Visibility(
                  child: Padding(
                    ...
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(
                        border: OutlineInputBorder(),
                        labelText: chosenDropdownValue == 'Timer'
                            ? 'Activity length'
                            : 'Duration goal',
                        suffixText: 'min',
                      ),
